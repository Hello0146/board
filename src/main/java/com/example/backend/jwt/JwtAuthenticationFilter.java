...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final com.example.backend.jwt.JwtTokenUtil jwtTokenUtil;

    public JwtAuthenticationFilter(
        UserDetailsService userDetailsService, com.example.backend.jwt.JwtTokenUtil jwtTokenUtil) {
